...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-br from-navy-deep via-navy to-blue-900 overflow-hidden min-h-[88vh] flex items-center">
      {/* Background Pattern */}
      ...
      {/* Decorative Blobs */}
      <div className="absolute right-[-80px] top-[-80px] w-[600px] h-[600px] rounded-full bg-blue/25 blur-3xl" />
      <div className="absolute left-[30%] bottom-[-100px] w-[400px] h-[400px] rounded-full bg-white/[0.04] blur-3xl" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="max-w-2xl">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-white/75 mb-11 leading-relaxed max-w-xl"
          >
