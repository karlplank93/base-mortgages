    ...
    <section className="bg-sand py-20 px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Right: Stats Card */}
          <div className="bg-navy-deep rounded-3xl p-10 text-white relative overflow-hidden">
            <div className="absolute top-[-60px] right-[-60px] w-56 h-56 rounded-full bg-teal/20 blur-3xl" />
            ...
            <div className="relative">
              <div className="grid grid-cols-2 gap-5 mb-6">
                <div className="bg-white/6 border border-white/10 rounded-2xl p-6">
                  ...
                  <div className="text-xs text-white/50 leading-snug">Google Reviews from NZ homeowners</div>
                </div>
                <div className="bg-white/6 border border-white/10 rounded-2xl p-6">
                  <div className="font-display text-5xl font-bold mb-1">5</div>
                  <div className="text-xs text-white/50 leading-snug">Major bank accreditations</div>
                </div>
                <div className="bg-white/6 border border-white/10 rounded-2xl p-6">
                  <div className="font-display text-5xl font-bold mb-1">24hr</div>
                  <div className="text-xs text-white/50 leading-snug">Average response time</div>
                </div>
                <div className="bg-white/6 border border-white/10 rounded-2xl p-6">
                  <div className="font-display text-5xl font-bold mb-1">$0</div>
                  <div className="text-xs text-white/50 leading-snug">Cost to you for our advice</div>
                </div>
              </div>

              <div className="bg-teal rounded-2xl p-5 text-center">
                <p className="text-sm text-white/85 mb-3">Ready to get started? Book a free call today.</p>
                <a
                  href="https://calendly.com/your-calendly-link"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block bg-white text-navy-deep rounded-lg px-6 py-2.5 font-bold text-sm hover:opacity-90 transition"
                >
                  Book Discovery Call →
                </a>
              </div>
