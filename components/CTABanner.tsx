...
export default function CTABanner() {
  return (
    <section className="relative overflow-hidden py-24 px-6 lg:px-8 text-center"
      ...
      <div className="relative max-w-3xl mx-auto w-full">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a href="https://calendly.com/karl-mortgage-adviser/borrowing-review" target="_blank" rel="noopener noreferrer"
            className="text-white px-8 py-4 rounded-xl font-bold text-lg transition shadow-cta hover:-translate-y-0.5"
