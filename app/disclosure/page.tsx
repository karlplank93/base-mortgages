...
export const metadata: Metadata = {
  ...
  description: 'Initial Disclosure Statement for Karl Plank, Financial Adviser at Base Mortgages Limited.',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="rounded-xl border border-gray-200 overflow-hidden mb-8">
          <table className="w-full text-sm">
            <tbody>
              {[
                ['Financial Adviser', 'Karl Plank'],
                ['Financial Advice Provider', 'I, Karl Plank, am providing financial advice on behalf of Base Mortgages Limited (FSP1011808)'],
                ['Physical Address', '1591 Dairy Flat Highway, Auckland, New Zealand 0794'],
                ['Telephone Number', '027 266 4925'],
                ['Email Address', 'karl@basemortgages.co.nz'],
              ].map(([label, value], i) => (
                <tr key={i} className={i % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                  <td className="px-6 py-4 font-semibold text-gray-700 w-48 align-top">{label}</td>
                  <td className="px-6 py-4 text-gray-600">
                    {label === 'Email Address'
                      ? <a href="mailto:karl@basemortgages.co.nz" className="underline" style={{ color: '#1fa59a' }}>{value}</a>
                      : value}
                  </td>
                </tr>
              ))}
